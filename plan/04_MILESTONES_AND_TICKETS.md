...
| M5-T3 — Lists and table candidates | Partial | Bullet/numbered list and simple text table candidates exist; row/cell reconstruction and rectangle/path table-border hints remain future work. |
