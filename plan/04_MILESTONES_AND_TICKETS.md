...
| M1.5-T4 — Compatibility corpus gate | Implemented | `spdfdiff corpus` emits deterministic per-file and diagnostic counts, supports the committed sample manifest, declared diff pairs, release-blocking gate thresholds, partial-file ceilings, and diagnostic-code maxima. |
