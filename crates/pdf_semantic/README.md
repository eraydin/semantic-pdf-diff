...
- Best-effort table row/cell evidence for aligned text grids, including sparse
  rows with deterministic blank cells, cell text, bounding boxes, provenance,
...
table spanning/merged-cell reconstruction, style semantics, OCR cleanup, and
full tagged-PDF parent tree behavior remain incremental compatibility work.
